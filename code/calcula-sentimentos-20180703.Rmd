...
Detectar o mínimo e o máximo dos resu

```{r, warning=FALSE, message=FALSE}
max(sentimentos$sentimento_op30)
min(sentimentos$sentimento_op30)
```

```{r, warning=FALSE, message=FALSE}
max(sentimentos$sentimento_sent)
min(sentimentos$sentimento_sent)
```
