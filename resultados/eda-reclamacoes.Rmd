...
A seguir iremos analisar as reclamações recebidas por dois órgãos do governo federal, sendo eles ANAC e INSS, e verificar a insatisfação do cliente quanto aos serviços desses órgãos públicos. Para isso, será utilizada a técnica de análise de sentimentos para detectar o nível de insastifação em cada reclamação, fazendo-se necessário o experimento humano de avaliação desse nível de insatisfação, feito pelo alunos da disciplina de Metodologia científica 2018.2 da UFCG, no qual cada reclamação era avaliada de 1 a 5, sendo que 1 equivalia a um nível de muito alto de insatisfação e 5 a um nível mais razoável de insatisfação. 
